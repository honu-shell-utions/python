...
##that all possible messages m (0≤m≤n-1) are unconcealed when calculating
##m^e mod n.  For any valid choice of e there exist some unconcealed messages.
...
print(f'Solution: {result}, Run-Time: {time()-start}')
#-------------------------------------------------------------------------------
