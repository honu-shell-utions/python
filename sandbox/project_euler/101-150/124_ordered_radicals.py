...
from sympy import sieve, factorint, primefactors
...
lst = [[i, rad(i)] for i in range(1, LIMIT)]
lst.sort(key=itemgetter(1))
print('ans:', lst[10**4-1], lst[10**4-1][0] == 21417)
print('runtime:', time()-go)
#solution: 21417
