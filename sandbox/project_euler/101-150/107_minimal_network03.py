...
################################################################################
start = time()
lst_edges = process_file()
tally_orig = calc_weight(lst_edges) // 2

lst_optimized = kruskal(lst_edges)
tally_optimized = calc_weight(lst_optimized)

print(' starting network weight:', tally_orig)
print('optimized network weight:', int(tally_optimized))
print('         maximum savings:', int(tally_orig - tally_optimized))
print()
print('runtime:', time() - start)
################################################################################
# ans for project euler: 259679
################################################################################
