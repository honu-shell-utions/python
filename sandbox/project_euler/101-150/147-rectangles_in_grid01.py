# p147_rectangles_cross-hatched_grids.py
#
# In a 3x2 cross-hatched grid, a total of 37 different rectangles could be 
# situated within that grid as indicated in the sketch.  (see pdf)
#  
...
ans = sum(lst)
print(f'number of rectangles within {WIDTH}x{HEIGHT} grid: {ans:,}  runtime: {time()-go}')
print(f'846,910,284 is correct? {846910284 == ans}')
