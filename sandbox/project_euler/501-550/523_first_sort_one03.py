...
#  a[n] = a[n-1]*n + (n-1)!*(2^(n-1) - 1)
#  a[30]=9847631899885656536190475358109696000000
#  E[30]=a[30]/30!
#  -----------------------------------------------------------------------------
...
def a(n):
    if n == 0:
        ...
        return a(n-1)*n + factorial(n-1)*(2**(n-1)-1)    
#  -----------------------------------------------------------------------------
def E(n):
...
for n in range(4,31):
    start = time()
    print(f'For n = {n:2}: {round(E(n),2):11}, Run-Time: {time()-start}')
#  -----------------------------------------------------------------------------
